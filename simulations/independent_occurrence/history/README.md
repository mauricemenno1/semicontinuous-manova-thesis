...
This folder contains the retained historical outputs used for the three independent-Bernoulli occurrence simulation tables in the submitted thesis.
...
```r
source("simulations/independent_occurrence/make_thesis_tables.R")
```
